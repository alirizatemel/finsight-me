...
with st.sidebar:
    ...
    st.page_link("pages/04_portfolio_dashboard.py", label="Portfolio Dashboard")
    st.page_link("pages/05_performance_log_update.py", label="Performance Log Update")
    ...
    st.markdown("### 📥 Data")
    st.page_link("pages/06_balance_download.py", label="Balance Download")
